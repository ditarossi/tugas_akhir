...
@section('title')
<title>Update Resi Pembayaran</title>
@endsection
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('tbl_resi/'.$model->id) }}" method="post">
                      @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input value="{{ $model->fasilitas_id }}" name="fasilitas_id" type="text" class="form-control" id="#" placeholder="Fasilitas">
                    </div>
                    <div class="form-group">
